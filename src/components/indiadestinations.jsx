...
function IndiaDestinations({ onBook }) {
  ...
  return (
    <section className="india-destinations" id="india">
      <div className="container">
        ...
        <div className="india-header">
          ...
          <p className="india-intro">
            From royal cities and Himalayan landscapes to
            tropical shores and the golden sands of Rajasthan,
            discover journeys across India.
          </p>
        </div>
        ...
        <div className="india-results">
          ...
          {indiaDestinations.length} destinations
        </div>
        ...
        {filteredDestinations.length > 0 ? (
          ...
          <div className="india-no-results">
            ...
            <p>
              Try searching for another Indian destination.
            </p>
